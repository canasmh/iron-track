...
import { isWorkingOutGuard } from './workout/is-working-out.guard';
...
const routes: Routes = [
  ...
  { path: 'workout/:workout_id', component: WorkoutComponent, canActivate: [AuthGuard], canDeactivate: [isWorkingOutGuard] }
